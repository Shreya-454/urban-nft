        ...
        <div className=' bg-[#EDF1F2]'>
            <sidebar className='relative'>
                <div className="container  lg:px-6 px-3 xl:max-w-[305px] lg:max-w-[180px] max-w-[100px] h-full overflow-y-scroll pt-8  bg-white fixed">
                    ...
                    <Link to={"/"} className='flex items-center justify-center lg:justify-normal gap-4 p-[13px] rounded-[22.5px] bg-transparent hover:bg-orange-white group'>
                        ...
                        <p className='font-inter text-[14px] font-semibold text-[#7C7C7C] lg:block hidden group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-text-gradient'>Dashboard</p>
                    </Link>
                    ...
                    <Link to={"/favorites"} className='flex items-center justify-center lg:justify-normal gap-4 p-[13px] rounded-[22.5px] bg-transparent hover:bg-orange-white group mb-[90px]'>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M7.99401 13.1878C7.84873 13.1923 7.7072 13.2314 7.5799 13.3012L4.25054 15.0404C3.84317 15.2348 3.35567 15.0839 3.12728 14.6943C3.04266 14.5352 3.01195 14.3528 3.04041 14.1741L3.70538 10.4774C3.75031 10.2086 3.66045 9.93542 3.465 9.74627L0.745953 7.11386C0.423201 6.79785 0.417211 6.27917 0.733223 5.95566C0.737716 5.95115 0.74146 5.9474 0.745953 5.94365C0.874754 5.81604 1.041 5.73197 1.21997 5.7057L4.97392 5.15325C5.24575 5.11872 5.48164 4.94908 5.60145 4.70288L7.23318 1.29734C7.3882 1.02261 7.68549 0.858979 8 0.876243C7.99401 1.09918 7.99401 13.0362 7.99401 13.1878Z" fill="#A8A8A8" className='group-hover:fill-[url(#paint1_linear_33_463)]' />
                        </svg>
                        <p className='font-inter text-[14px] lg:block hidden font-semibold text-[#7C7C7C] group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-text-gradient '>Favorites</p>
                  </Link>
                    <h5 className='font-Inter lg:block hidden  text-[12px] font-medium text-black mb-4 pl-[13px]'>MY PROFILE</h5>
                    <Link to={"/Insight"} className='flex gap-4 items-center justify-center lg:justify-normal p-[13px] rounded-[22.5px] bg-transparent hover:bg-orange-white group'>
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="Iconly/Bulk/Activity">
                                    <g id="Activity">
                                        <path id="Path_34168" fill-rule="evenodd" clip-rule="evenodd" d="M11.4321 3.55317C11.4321 5.21892 12.7844 6.56927 14.4526 6.56927C14.6363 6.56836 14.8195 6.55073 15 6.51659V12.4961C15 15.0117 13.5161 16.5 10.9968 16.5H5.50977C2.98388 16.5 1.5 15.0117 1.5 12.4961V7.01707C1.5 4.50146 2.98388 3 5.50977 3H11.4849C11.4494 3.18225 11.4317 3.36751 11.4321 3.55317ZM9.86248 11.1724L12.0059 8.40659V8.39341C12.1894 8.14685 12.1425 7.79917 11.9003 7.60976C11.7831 7.51926 11.6342 7.48009 11.4875 7.50119C11.3408 7.52229 11.209 7.60185 11.1221 7.72171L9.3151 10.0463L7.25745 8.42634C7.13997 8.33482 6.99053 8.29441 6.84286 8.31424C6.69519 8.33406 6.56174 8.41245 6.47264 8.53171L4.25672 11.3898C4.17883 11.4868 4.13689 11.6078 4.13801 11.7322C4.12515 11.9836 4.2839 12.212 4.52428 12.2879C4.76466 12.3637 5.02603 12.268 5.16023 12.0549L7.01343 9.6578L9.07108 11.2712C9.18811 11.3656 9.33854 11.4083 9.4878 11.3897C9.63705 11.3711 9.77231 11.2927 9.86248 11.1724Z" fill="#A8A8A8" className='group-hover:fill-[url(#paint1_linear_33_463)]' />
                                        <circle id="Ellipse_742" opacity="0.4" cx="14.625" cy="3.375" r="1.875" fill="#A8A8A8" className='group-hover:fill-[url(#paint1_linear_33_463)]' />
                                    </g>
                                </g>
                            </svg>
                            <p className='font-Inter lg:block hidden text-[14px] font-semibold text-[#7C7C7C] group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-text-gradient'>Insight</p>
                    </Link>
                    <Link to={"/Wallet"} className='flex gap-4 items-center justify-center lg:justify-normal  p-[13px] rounded-[22.5px] bg-transparent hover:bg-orange-white group'>
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="Iconly/Bulk/Wallet">
                                    <g id="Wallet">
                                        <path id="Fill 1" fill-rule="evenodd" clip-rule="evenodd" d="M16.4973 6.28134H13.3213C11.8433 6.28394 10.646 7.45136 10.6433 8.89242C10.6413 10.3367 11.84 11.5094 13.3213 11.5113H16.5V11.7408C16.5 14.2602 14.9727 15.75 12.388 15.75H5.61267C3.02733 15.75 1.5 14.2602 1.5 11.7408V6.25339C1.5 3.73397 3.02733 2.25 5.61267 2.25H12.3853C14.97 2.25 16.4973 3.73397 16.4973 6.25339V6.28134ZM5.05467 6.2755H9.28467H9.28733H9.29267C9.60933 6.27419 9.86533 6.02264 9.864 5.71324C9.86267 5.40448 9.604 5.15488 9.28733 5.15618H5.05467C4.74 5.15748 4.48467 5.40644 4.48333 5.71389C4.482 6.02264 4.738 6.27419 5.05467 6.2755Z" fill="#A8A8A8" className='group-hover:fill-[url(#paint1_linear_33_463)]' />
                                        <path id="Fill 4" opacity="0.4" d="M12.0281 9.22231C12.1849 9.93569 12.8104 10.4376 13.5244 10.4246H15.9619C16.259 10.4246 16.5 10.1785 16.5 9.87434V7.97567C16.4994 7.67217 16.259 7.42546 15.9619 7.4248H13.4671C12.6548 7.42742 11.9987 8.10164 12 8.93251C12 9.02976 12.0096 9.12701 12.0281 9.22231Z" fill="#A8A8A8" className='group-hover:fill-[url(#paint1_linear_33_463)]' />
                                        <circle id="Oval" cx="13.5" cy="8.9248" r="0.75" fill="#A8A8A8" className='group-hover:fill-[url(#paint1_linear_33_463)]' />
                                    </g>
                                </g>
                            </svg>
                            <p className='font-Inter lg:block hidden text-[14px] font-semibold text-[#7C7C7C] group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-text-gradient'>Wallet</p>
                    </Link>
                    <Link to={"/Profile"} className='flex gap-4 items-center p-[13px] rounded-[22.5px] justify-center lg:justify-normal bg-transparent hover:bg-orange-white group'>
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="Iconly/Bulk/Profile">
                                    <g id="Profile">
                                        <path id="Fill 1" d="M8.99775 11.3813C5.763 11.3813 3 11.8913 3 13.9313C3 15.9721 5.74575 16.5001 8.99775 16.5001C12.2325 16.5001 14.9955 15.9908 14.9955 13.9501C14.9955 11.9093 12.2505 11.3813 8.99775 11.3813Z" fill="#A8A8A8" className='group-hover:fill-[url(#paint1_linear_33_463)]' />
                                        <path id="Fill 4" opacity="0.4" d="M8.99732 9.438C11.2008 9.438 12.9663 7.67175 12.9663 5.469C12.9663 3.26625 11.2008 1.5 8.99732 1.5C6.79457 1.5 5.02832 3.26625 5.02832 5.469C5.02832 7.67175 6.79457 9.438 8.99732 9.438Z" fill="#A8A8A8" className='group-hover:fill-[url(#paint1_linear_33_463)]' />
                                    </g>
                                </g>
                            </svg>
                            <p className='font-Inter lg:block hidden font-semibold text-[14px] text-[#7C7C7C] group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-text-gradient'>Profile</p>
                    </Link>
